...
namespace EmailSender
{
    public class Email
    {
        ...
        public Email(EmailParams emailParams)
        {
            ...
            _enableSsl = emailParams.EnableSssl;
        ...
        public async Task Send(string subject, string body, string to)
        {
            ...
            _mail.AlternateViews.Add(AlternateView.CreateAlternateViewFromString($@"
                <html>
                    ...
                    <body>
                        <div style='font-size: 16px; padding: 10px; font-family: Roboto; line-height:1.4;'>
                            {body}
                         </div>
                    </body>
                </html>
            ...
            _smtp.SendCompleted += OnSendComplited;

            await _smtp.SendMailAsync(_mail);
        }

        private void OnSendComplited(object sender, AsyncCompletedEventArgs e)
        {
            _smtp.Dispose();
            _mail.Dispose();
        }
